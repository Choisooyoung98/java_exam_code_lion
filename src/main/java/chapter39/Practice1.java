...
class 오리 {
    private String 종류;
    private 비행아이템 비행아이템1;
    private 울음아이템 울음아이템1;
    오리(String 종류) {
        this.종류=종류;
        this.종류 = this.종류 + "오리";
    }
    ...
    public void set비행아이템(비행아이템 비행아이템1) {
        this.비행아이템1 = 비행아이템1;
    }

    public void set울음아이템(울음아이템 울음아이템1) {
        this.울음아이템1 = 울음아이템1;
    }
}
interface 비행아이템 {
...
class 오리공장{
    static 오리 get(String 종류) {
        오리 오리1 = new 오리(종류);

        switch (종류) {
            case "흰":
            case "청둥":
                오리1.set비행아이템(new 날개비행아이템());
                오리1.set울음아이템(new 꽥울음아이템());
                break;
            case "고무":
                오리1.set비행아이템(new 못나는비행아이템());
                오리1.set울음아이템(new 삑삑울음아이템());
                break;
            case "고무2":
                오리1.set비행아이템(new 못나는비행아이템());
                오리1.set울음아이템(new Peek울음아이템());
                break;
            case "로봇":
                오리1.set비행아이템(new 로켓날개비행아이템());
                오리1.set울음아이템(new 기계울음아이템());
                break;
        }
        return 오리1;
    }
